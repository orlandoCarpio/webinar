...
function twentytwenty_register_styles() {
	...
	wp_enqueue_style( 'twentytwenty-all', get_theme_file_uri( ).'/assets/css/all.min.css', array(), '5.14.0', 'all' );
	// Add print CSS.
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'script-js', get_template_directory_uri() . '/assets/js/script-web.js', array(), '1.2.2', true );
...
function twentytwenty_menus() {
	...
	$locations = array(
		...
		'second'=>__('Menu Principal','twentytwenty'),
		'menu_social'=>__('Redes Sociales','twentytwenty'),
	);
...
//nuevo
	register_sidebar(
		array(
			'name'=>__('Buscar','twentytwenty'),
			'id'=>'buscar-post',
		)
	);
	register_sidebar(
		array(
			'name'=>__('Galeria','twentytwenty'),
			'id'=>'galeria',
		)
	);
...
//lista de categorias para el blog
function shortcode_lisscat() {
	$tipo=is_page('blog')?16:21;
	echo "<ul>";
	...
	add_shortcode('categoria-blog',    'shortcode_lisscat');	
//ultimas entradas de blog
//[recientes-blog  limite="3" longitud_titulo="50" longitud_desc="100" thumbnail="1" tamano="50" categoria="4"]
function shortcode_recientes($atts, $content = null, $code) {
	  $tipo=is_page('blog')?16:21;
	  $tipo=is_page('ventas')?27:$tipo;
	  $page=is_page('ventas')?'singleventas':'singleblog';
...
add_shortcode('recientes-blog',    'shortcode_recientes');
