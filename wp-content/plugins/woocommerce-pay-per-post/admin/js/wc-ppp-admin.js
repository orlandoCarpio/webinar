(function ($) {
    ...
    $(function () {
        ...
        $(".wc_pay_per_post_display_on_my_account").change(function (e) {

            if ($(this).prop('checked')) {
                alert('After saving these options, you may have to resave your permalinks if the link on the My Account pages goes to a 404 page.  You can easily resave  your permalinks by going to Settings->Permalinks and just pressing the save button.  ');
            }
